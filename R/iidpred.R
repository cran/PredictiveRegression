...
# Description: paper by Vovk et al. in Annals of Statistics, 2008
# (arXiv ST0511522), referred to as "paper".
# The algorithm implemented: Vovk, Gammerman, Shafer
...
# epsilons is the list of significance levels to consider
  ...
  A <- array(0,c(N+1,1));		# vector A from the IID predictor
